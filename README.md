This is a simple program that I build in my C-Programming course that utilizes if-statements and do-while loops. It is a make believe program that allows for users to use a supercomputer at a cost.
